...
| Sonarr               | sonarr.yourdomain.com      | [linuxserver/sonarr](https://hub.docker.com/r/linuxserver/sonarr)      | *latest*<s>*preview*               | TV Shows monitor    |
...
| Lidarr               | lidarr.yourdomain.com      | [linuxserver/lidarr](https://hub.docker.com/r/linuxserver/lidarr)      | *latest*<s>*preview*               | Music monitor       |
...
| <s>NextCloud            | <s>nextcloud.yourdomain.com   | <s>[wonderfall/nextcloud](https://hub.docker.com/r/wonderfall/nextcloud)  | *latest*                | Files management    |
| <s>Duplicati            | <s>duplicati.yourdomain.com   | <s>[linuxserver/duplicati](https://hub.docker.com/r/linuxserver/duplicati)| *latest*                | Backups             |
| <s>Attestation COVID-19 | <s>attestation.yourdomain.com | <s>[fromenje/attestation-covid-19](https://hub.docker.com/r/fromenje/attestation-covid-19) | *latest* | (France) Attestation de déplacement, mémorise les champs dans le navigateur |
